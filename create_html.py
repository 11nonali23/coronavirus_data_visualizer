...
def general_updates():
    ...
    <div class="percentage_shower" style="margin-top: 40px;">
        <ul>
            ...
            <li><h3 style="font-family: courier,arial,helvetica;"><b>circa l' {}%</b> delle persone sono guarite </h3></li>
        </ul>
        <p style="margin-top: 35px;">
            <h4 style="margin-left: 25px;"><b>N.B.</b></h4>
            <h6 style="font-family: courier,arial,helvetica;margin-left: 25px;">Calcoli fatti sulle persone testate con il tampone: i contagiati reali potrebbero essere molti di più.</h6>
        <p>
